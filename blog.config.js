...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '我阿妈每天早上6，7点钟就要起来给我充电子烟。', // 作者简介
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://www.instagram.com/iamnotcxk/', // 你的linkedIn 首页
